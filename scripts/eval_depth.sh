...
# --load_weights_folder /mnt/nct-zfs/TCO-Test/jinjingxu/exps/train/mvp3r/results/unisfm/endodac/full_endodacB_angleaxis_baseline_1211_0028/models/weights_19 \
# --load_weights_folder /mnt/cluster/workspaces/jinjingxu/proj/PAL-SfmLearner/weights/endodac_pretrained \
