...
from depth_anything_3.model.dinov2.layers import LayerScale  # noqa: F401
from depth_anything_3.model.dinov2.layers import Mlp  # noqa: F401
...
def vit_small(patch_size=16, num_register_tokens=0, depth=12, **kwargs):
    model = EndoDinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=384,
        depth=depth,
        num_heads=6,
